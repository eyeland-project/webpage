	...
	return (
		<div className="flex h-auto w-screen flex-col-reverse items-center justify-center gap-3 px-20 md:flex-row xl:gap-20">
			<div className="flex flex-col items-start xl:w-[550px]">
				<h1 className="to animate-entrance-1 bg-gradient-to-r from-greenPrimary to-greenSecondary bg-clip-text text-7xl font-bold text-transparent xl:text-9xl">
					EYELAND
				</h1>
				...
				<div className="button mt-5 animate-entrance-3 cursor-default bg-greenTertiary text-xl text-white xl:text-4xl">
					¡Muy Pronto!
				</div>
			</div>
